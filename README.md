...
### RnD 01
- Точка входа №1 (навигация): `rnd_01_ab_дизайн_экспериментов/README.md`
- Точка входа №2 (краткий итог): `rnd_01_ab_дизайн_экспериментов/report.md`

Этот формат сделан специально для удобного онбординга: сначала короткий итог, затем переходы в нужные ноутбуки и секции.

## Актуальная структура

- `rnd_01_ab_дизайн_экспериментов/` — текущий реализованный RnD.
  - `README.md` — главная навигация по RnD (ссылки на все секции и код).
  - `report.md` — краткий консолидированный отчёт по результатам RnD.
...
- Для каждого RnD обязательно поддерживаются 1–2 понятные точки входа в корне папки RnD.
