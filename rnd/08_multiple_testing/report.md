...
незначимости и какие метрики дают надёжный сигнал. Цвет точек слева — по самому ДИ: красные не
включают 0 (сырой сигнал, до поправки на множественность), синие включают; решения методов с
поправкой полностью отражены на правой панели, поэтому левая не привязана к одному методу.
